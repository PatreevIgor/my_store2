...
Product.create(title: 'Автоклав на 30 литров',
               description: 'Если Вы занимаетесь домашними заготовками, охотой или рыбалкой, то этот товар точно для Вас. Автоклав предназначен для изготовления тушенки, консервов, салатов, грибов или любых других закаток. Вместимость: 21 банка по 0,5 литра или 10 банок по 1 литру. Гарантия 1 год. Книга рецептов в подарок бесплатно. 10 причин купить АВТОКЛАВ:
1. Вы экономите свое время и силы ― Автоклав готовит все сам, а Вы занимаетесь своими делами, наблюдая лишь за давлением ― больше нет необходимости тратить на консервирование весь день.
2. Приготовить консервы теперь можно в 5 раз быстрее. Автоклав за 1 цикл приготовит 21 банку ваших любимых закаток.
3. Ваши банки больше не "взорвутся" и продукты не испортятся ― Автоклав делает свою работу идеально.
4. Теперь Вы сможете заготовить абсолютно любые консервы (в т.ч. тушенку, рыбу) и быть уверенными в их качестве. Кроме того, у вас будет Книга рецептов, с помощью которых Вы разнообразите свои заготовки.
5. Консервы хранятся намного дольше, т.к. приготовлены в условиях, приближенных к заводским (давление, высокая температура, закупоренные банки исключают возможность попадания бактерий и их размножение).
6. Исключается вероятность ожогов ― нет открытого пара, банки достаете охлажденными.
7. У Вас чистая кухня и нет море грязной посуды, т.к. весь процесс происходит внутри установки в закатанных банках.
8. Вы можете использовать Автоклав в любом месте ― на даче, дома, даже на костре.
9. Ваш Автоклав прослужит Вам не менее 15 лет, т.к. произведен из настоящей качественной стали.
10. Вы экономите до 3 000 000 руб., покупая Автоклав белорусского производства. Российские аналоги стоят гораздо дороже.После покупки Вы останетесь довольны.',
               price: '1350000',
               types: 'автоклавы')

Product.create(title: 'Автоклав на 24 литра',
               description: 'Если Вы занимаетесь домашними заготовками, охотой или рыбалкой, то этот товар точно для Вас. Автоклав предназначен для изготовления тушенки, консервов, салатов, грибов или любых других закаток. Вместимость: 14 банка по 0,5 литра или 5 банок по 1 литру. Гарантия 1 год. Книга рецептов в подарок бесплатно. 10 причин купить АВТОКЛАВ:
1. Вы экономите свое время и силы ― Автоклав готовит все сам, а Вы занимаетесь своими делами, наблюдая лишь за давлением ― больше нет необходимости тратить на консервирование весь день.
2. Приготовить консервы теперь можно в 5 раз быстрее. Автоклав за 1 цикл приготовит 21 банку ваших любимых закаток.
3. Ваши банки больше не "взорвутся" и продукты не испортятся ― Автоклав делает свою работу идеально.
4. Теперь Вы сможете заготовить абсолютно любые консервы (в т.ч. тушенку, рыбу) и быть уверенными в их качестве. Кроме того, у вас будет Книга рецептов, с помощью которых Вы разнообразите свои заготовки.
